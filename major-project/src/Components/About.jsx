        ...
        <div className="row g-5">
          <div className="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
            ...
            <h1 className="display-5 mb-4">
              ...
              <span className="text-primary">Ducart</span> Ducart!
            </h1>
            <p className="mb-4">
            ...
            <h5 className="mb-3">
              <i className="far fa-check-circle text-primary me-3"></i>World Top Brands
            </h5>
            <Link className="btn btn-primary py-3 px-5 mt-3" to="/shop">Shop Now</Link>
          </div>
          <div className="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
            <div className="img-border">
              <img className="img-fluid" src="img/img15.jpg" alt="Banner Image" />
            </div>
          </div>
        </div>
      </div>
