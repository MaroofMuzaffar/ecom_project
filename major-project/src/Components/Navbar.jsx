  ...
  return (
                ...
                <div className="row gx-0 d-none d-lg-flex">
                    <div className="col-lg-7 px-5 text-start">
                        <div className="h-100 d-inline-flex align-items-center py-3 me-4">
                            ...
                            <Link to="mailto:khanmaroof317@gmail.com" target='_blank' rel='noreferrer'>khanmaroof317@gmail.com</Link>
                        </div>
                        <div className="h-100 d-inline-flex align-items-center py-3 me-4">
                            <small className="fa fa-phone text-primary me-2"></small>
                            <Link to="tel:+916005821865" target='_blank' rel='noreferrer'>+91-6005821865</Link>
                        </div>
                        <div className="h-100 d-inline-flex align-items-center py-3 me-4">
                            <small className="fa fa-whatsapp text-primary me-2"></small>
                            <Link to="https://wa.me/+919596399388" target='_blank' rel='noreferrer'>+91-9596399388</Link>
                        </div>
                    </div>
    ...
    >
      <Link to="/" className="navbar-brand p-0">
        <i className='fa fa-shopping-bag text-primary fs-1 m-2'></i>
      ...
      <div className="collapse navbar-collapse py-4 py-lg-0" id="navbarCollapse">
        <div className="navbar-nav ms-auto">
          ...
          <NavLink to="/testmonial" className="nav-item nav-link">Testimonials</NavLink>
