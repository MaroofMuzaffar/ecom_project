...
export default function Sidebar() {
  return (
    ...
    <Link to="/admin/testmonials" className="list-group-item list-group-item-action" aria-current="true"><i className='fa fa-star fs-3'></i> <span className='float-end'>Testimonial</span></Link>
