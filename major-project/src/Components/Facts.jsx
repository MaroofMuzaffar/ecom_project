      ...
      <div className="container py-5">
        <div className="row g-4">
          ...
          >
            ...
            <p className="text-white mb-0">HappyCostumers</p>
          </div>
          <div
            className="col-md-6 col-lg-3 text-center wow fadeIn"
            data-wow-delay="0.3s"
          >
            ...
            <p className="text-white mb-0">TopBrands</p>
          </div>
          <div
            className="col-md-6 col-lg-3 text-center wow fadeIn"
            data-wow-delay="0.5s"
          >
            ...
            <p className="text-white mb-0">OriginalProducts</p>
          </div>
          <div
            className="col-md-6 col-lg-3 text-center wow fadeIn"
            data-wow-delay="0.7s"
          >
            ...
            <p className="text-white mb-0">CostumerSupport</p>
          </div>
        </div>
      </div>
    </div>
