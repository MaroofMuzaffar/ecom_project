  ...
  return (
    <>
      <div className="container-fluid footer bg-dark text-light footer mt-5 pt-5 wow fadeIn" data-wow-delay="0.1s" >
       ...
       <p className="mb-2"><i className="fa fa-map-marker me-3"></i>JammuAndKashmir</p>
        <Link className="mb-2 text-light d-block" to="tel:+916005821865"><i className="fa fa-phone me-3"></i>+91-6005821865</Link>
        <Link className="mb-2 text-light d-block" to="mailto:khanmaroof317@gmail.com"><i className="fa fa-envelope me-3"></i>khanmaroof317@gmail.com</Link>
         <div className="d-flex pt-2">
          ...
          <h5 className="text-light mb-4">Quick Links</h5>
          <Link className="btn btn-link" to ="/testmonials">Testimonials</Link>
          ...
          <p className='text-justify'>Dolor amet sit justo amet elitr clita ipsum elitr est.</p>
          {show ? <p>{show}</p> : null}
        ...
        <div className="container">
         <div className="copyright">
          <div className="row">
          <div className="col-md-6 text-center text-md-start mb-3 mb-md-0">&copy; <a className="border-bottom" href="#">ducart</a>, All Right Reserved.</div>
            </div>
            </div>
            </div>
            </div>
