  ...
  function postData(e) {
    ...
    if (error)
      ...
      setShow(true);
        ...
        let stockQuantity=parseInt(stockQuantity)
        let bp=parseInt(data.basePrice)
        let fp=parseInt(data.finalPrice)
        ...
        dispatch(updateProduct({ 
          ...
          brand:data.brandrand!==""?data.brand:BrandStateData[0].name,
      ...
      <div className="container-fluid">
        <div className="row">
          ...
          <div className="col-md-9">
            <h5 className="bg-primary text-center text-light p-2">Update Product{" "}<Link to="/admin/product">{" "}<i className="fa fa-backward text-light float-end"></i>
              </Link>
            </h5>
            <form onSubmit={postData}>
              <div className="mb-3">
                <label>Name*</label>
                <input type="text" name="name" value={data.name} onChange={getInputData} className={`form-control border-3 ${show && errorMessage.name? "border-danger": "border-primary"}`}
              ...
              <div className="row">
                <div className="col-md-6 mb-3">
                  ...
                  <input type="number" value={data.basePrice} name="basePrice" onChange={getInputData} className={`form-control border-3 ${show && errorMessage.basePrice ? 'border-danger' : 'border-primary'}`} placeholder='Product Base Price' />
                  {show && errorMessage.basePrice ? <p className='text-danger text-capitalize'>{errorMessage.basePrice}</p> : null}
                </div>

                <div className="col-md-6 mb-3">
                  <label>Discount*</label>
                  <input type="number"  value={data.discount} name="discount" onChange={getInputData} className={`form-control border-3 ${show && errorMessage.discount ? 'border-danger' : 'border-primary'}`} placeholder='Product Discount' />
              ...
              <div className="row">
                <div className="col-md-6 mb-3">
                  ...
                  <input type="number" value={data.stockQuantity} name="stockQuantity" onChange={getInputData} className={`form-control border-3 ${show && errorMessage.stockQuantity ? 'border-danger' : 'border-primary'}`} placeholder='Product Stock Quantity' />
