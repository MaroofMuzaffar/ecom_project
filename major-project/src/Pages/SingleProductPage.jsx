                            ...
                            <div className="carousel-indicators">
                                <button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="0" className="active" aria-current="true" aria-label="Slide 1"></button>
                                {
                                    data.pic?.slice(1).map((item, index) => {
                                        return <button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to={index + 1} aria-label={`Slide ${index + 2}`}></button>
                                    })
                                }
                            </div>
                        ...
                        <div className={`d-flex my-3 ${data.pic.length < 4 ? '' : 'justify-content-between'}`}>
                            {
                                data.pic?.map((item, index) => {
                                    return <img src={`${process.env.REACT_APP_SERVER}${item}`} height={100} width={100} className='me-1' data-bs-target="#carouselExampleIndicators" data-bs-slide-to={index} aria-label={`Slide ${index + 1}`} />
                                })
                            }
                        </div>
                    </div>
